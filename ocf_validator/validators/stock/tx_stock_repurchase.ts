...
const valid_tx_stock_repurchase = (context: OcfMachineContext, event: any, isGuard: Boolean) => {
  let validity = false;
  let report: any = {transaction_type: "TX_STOCK_REPURCHASE", transaction_id: event.data.id, transaction_date: event.data.date};
