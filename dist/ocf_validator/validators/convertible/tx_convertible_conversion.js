...
*/
const valid_tx_convertible_conversion = (context, event, isGuard) => {
    let validity = false;
    const { transactions } = context.ocfPackageContent;
    let report = { transaction_type: "TX_CONVERTIBLE_CONVERSION", transaction_id: event.data.id, transaction_date: event.data.date };
    // Check that convertible issuance in incoming security_id referenced by transaction exists in current state.
...
exports.default = valid_tx_convertible_conversion;
