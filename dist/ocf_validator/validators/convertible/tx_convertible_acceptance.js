...
const valid_tx_convertible_acceptance = (context, event, isGuard) => {
    const { transactions } = context.ocfPackageContent;
    let validity = false;
    let report = { transaction_type: "TX_CONVERTIBLE_ACCEPTANCE", transaction_id: event.data.id, transaction_date: event.data.date };
...
exports.default = valid_tx_convertible_acceptance;
