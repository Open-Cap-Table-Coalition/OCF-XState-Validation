...
const valid_tx_convertible_retraction = (context, event, isGuard = false) => {
    let validity = false;
    let report = { transaction_type: "TX_CONVERTIBLE_RETRACTION", transaction_id: event.data.id, transaction_date: event.data.date };
...
exports.default = valid_tx_convertible_retraction;
