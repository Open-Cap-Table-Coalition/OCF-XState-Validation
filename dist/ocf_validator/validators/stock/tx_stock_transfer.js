...
*/
const valid_tx_stock_transfer = (context, event, isGuard) => {
    let validity = false;
    const { transactions } = context.ocfPackageContent;
    let report = { transaction_type: "TX_STOCK_TRANSFER", transaction_id: event.data.id, transaction_date: event.data.date };
...
exports.default = valid_tx_stock_transfer;
