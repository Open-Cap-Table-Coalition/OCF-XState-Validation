...
const valid_tx_warrant_issuance = (context, event, isGuard) => {
    let validity = false;
    const { stakeholders } = context.ocfPackageContent;
    let report = { transaction_type: "TX_WARRANT_ISSUANCE", transaction_id: event.data.id, transaction_date: event.data.date };
...
exports.default = valid_tx_warrant_issuance;
