...
const valid_tx_equity_compensation_cancellation = (context, event, isGuard = false) => {
    let validity = false;
    let report = { transaction_type: "TX_EQUITY_COMPENSATION_CANCELLATION", transaction_id: event.data.id, transaction_date: event.data.date };
...
exports.default = valid_tx_equity_compensation_cancellation;
