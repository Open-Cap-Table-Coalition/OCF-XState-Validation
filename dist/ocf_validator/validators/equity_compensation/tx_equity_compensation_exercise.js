...
*/
const valid_tx_equity_compensation_exercise = (context, event, isGuard) => {
    let validity = false;
    const { transactions } = context.ocfPackageContent;
    let report = { transaction_type: "TX_EQUITY_COMPENSATION_EXERCISE", transaction_id: event.data.id, transaction_date: event.data.date };
    // Check that equity_compensation issuance in incoming security_id referenced by transaction exists in current state.
...
exports.default = valid_tx_equity_compensation_exercise;
