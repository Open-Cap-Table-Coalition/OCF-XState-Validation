...
*/
const valid_tx_equity_compensation_transfer = (context, event, isGuard) => {
    let validity = false;
    const { transactions } = context.ocfPackageContent;
    let report = { transaction_type: "TX_EQUITY_COMPENSATION_TRANSFER", transaction_id: event.data.id, transaction_date: event.data.date };
    ...
    context.equityCompensation.map((ele) => {
...
exports.default = valid_tx_equity_compensation_transfer;
